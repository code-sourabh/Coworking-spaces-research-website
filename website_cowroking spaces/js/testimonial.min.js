                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    if (!a.isEmptyObject(e)) {
                        ...
                        d.off("keyup.autocomplete").on("keyup.autocomplete", function(g) {
                            ...
                            return 13 === c ? (b = j.children("li").eq(g), void(b.length && (b.click(), a.preventDefault()))) : void(38 !== c && 40 !== c || (a.preventDefault(), 38 === c && g > 0 && g--, 40 === c && g < d - 1 && e.length && g++, e.removeClass("active"), j.children("li").eq(g).addClass("active")))
                        }), j.on("click", "li", function() {
                            var c = a(this).text().trim();
                            d.val(c), d.trigger("change"), j.empty(), l(), "function" == typeof b.onAutocomplete && b.onAutocomplete.call(this, c)
                        })
                    }
                })
            }
        ...
        a(document).ready(function() {
            ...
            d.hasAutocomplete = !a.isEmptyObject(e.autocompleteData), this.init = function() {
                ...
                b.data("chips").forEach(function(a) {
                    f += d.renderChip(a)
                }), f += '<input id="' + c + '" class="input" placeholder="">', b.html(f), d.setPlaceholder(b);
                var g = b.next("label");
                g.length && (g.attr("for", c), b.data("chips").length && g.addClass("active"));
                var h = a("#" + c);
                d.hasAutocomplete && h.autocomplete({
                    data: e.autocompleteData,
                    limit: e.autocompleteLimit,
